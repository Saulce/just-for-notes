...
![65533](./assets/65533.webp)

可以看到，还是不行，接下来看看 varchar(65532) 是否可行？

![65532](./assets/65532.webp)
...
![comparison-of-common-mysql-storage-engines](./assets/comparison-of-common-mysql-storage-engines.png)
